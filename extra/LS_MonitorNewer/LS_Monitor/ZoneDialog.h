...
public:
	...
	bool GetBillingFlag()									{ return m_billingFlag; }
...
protected :
	...
	bool WriteLog(int currentUser);
	ULONGLONG DiffTime(SYSTEMTIME time1, SYSTEMTIME time2);

public:
	CIOSocket*	GetSockMain();
