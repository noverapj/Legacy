...
//		call	GetBarColor()
//		or		SendMessage (PBM_USERGETBARCOLOR, 0, 0)
//		or		::SendMessage (m_hwnd, PBM_USERGETBARCOLOR, 0, 0)
//
...
#define PBM_USERGETBARCOLOR			(WM_USER+100)
#define PBM_USERGETBKCOLOR			(WM_USER+101)
...
class CTextProgressCtrl : public CProgressCtrl
{
	...
	public:
		...
		inline COLORREF GetBarColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_USERGETBARCOLOR, 0, 0)); }
		...
		inline COLORREF GetBarBkColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_USERGETBKCOLOR, 0, 0)); }
