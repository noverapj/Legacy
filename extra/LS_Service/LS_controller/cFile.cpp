...
BOOL cFileWriter::Open(const TCHAR* fileName, DWORD diposition)
{
	if(0 == diposition)
	{
	...
	if(cFile::Open(fileName, GENERIC_WRITE | GENERIC_READ, FILE_SHARE_READ | FILE_SHARE_WRITE, diposition))
	{
		//WriteHeader();
		return TRUE;
	}
