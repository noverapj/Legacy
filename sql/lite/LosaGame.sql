...
CREATE INDEX [idx_userIP] ON [define_blockIP] ([userIP] ASC);
CREATE INDEX [idx_idx] ON [define_class_price] ([idx] ASC);
CREATE INDEX [idx_idx_define_config] ON [define_config] ([idx] ASC);
CREATE INDEX [idx_objName] ON [define_config] ([objName] ASC);
CREATE INDEX [idx_connNumber] ON [define_game_server] ([connNumber] ASC);
CREATE INDEX [idx_serverIP] ON [define_game_server] ([serverIP] ASC);
CREATE INDEX [idx_idx_define_gear_customidx] ON [define_gear_customidx] ([idx] ASC);
CREATE INDEX [idx_content] ON [define_site_config] ([content] ASC);
CREATE INDEX [idx_idx_define_site_config] ON [define_site_config] ([idx] ASC);
CREATE INDEX [idx_objName_define_site_config] ON [define_site_config] ([objName] ASC);
CREATE INDEX [idx_accountIDX] ON [userAbilityDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userAbilityDB] ON [userAbilityDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userAwardDB] ON [userAwardDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userAwardDB] ON [userAwardDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userCharacterDB] ON [userCharacterDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userCharacterDB] ON [userCharacterDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userClassDB] ON [userClassDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userClassDB] ON [userClassDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userConfigDB] ON [userConfigDB] ([accountIDX] ASC);
CREATE INDEX [idx_accountIDX_userCooperationDB] ON [userCooperationDB] ([accountIDX] ASC);
CREATE INDEX [idx_cpID] ON [userCooperationDB] ([cpID] ASC);
CREATE INDEX [idx_cpType] ON [userCooperationDB] ([cpType] ASC);
CREATE INDEX [idx_accidx_evntype] ON [userEventDB] ([accountIDX] ASC, [eventType] ASC);
CREATE INDEX [idx_accountIDX_userEventDB] ON [userEventDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userEventDB] ON [userEventDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userFishDB] ON [userFishDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userFishDB] ON [userFishDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userFriendBestDB] ON [userFriendBestDB] ([accountIDX] ASC);
CREATE INDEX [idx_flag] ON [userFriendBestDB] ([flag] ASC);
CREATE INDEX [idx_friendIDX] ON [userFriendBestDB] ([friendIDX] ASC);
CREATE INDEX [idx_idx_userFriendBestDB] ON [userFriendBestDB] ([idx] ASC);
CREATE INDEX [idx_accIDX] ON [userFriendDB] ([userAccIDX] ASC, [friendAccIDX] ASC);
CREATE INDEX [idx_friendAccIDX] ON [userFriendDB] ([friendAccIDX] ASC);
CREATE INDEX [idx_idx_userFriendDB] ON [userFriendDB] ([idx] ASC);
CREATE INDEX [idx_userAccIDX] ON [userFriendDB] ([userAccIDX] ASC);
CREATE INDEX [NC_userGoldDB_idx] ON [userGoldDB] ([idx] ASC);
CREATE INDEX [CX_userGuildAttendDB_RegDate_GuildIDX] ON [userGuildAttendDB] ([InitDate] ASC, [GuildIDX] ASC);
CREATE INDEX [idx_idx_userGuildDB] ON [userGuildDB] ([idx] ASC);
CREATE INDEX [ncx_userGuildHQDB_ItemSerial] ON [userGuildHQDB] ([ItemSerial] ASC);
CREATE INDEX [idx_accountIDX_userGuildInfoDB] ON [userGuildInfoDB] ([accountIDX] ASC);
CREATE INDEX [idx_guildIDX] ON [userGuildInfoDB] ([guildIDX] ASC);
CREATE INDEX [idx_idx_userGuildInfoDB] ON [userGuildInfoDB] ([idx] ASC);
CREATE INDEX [idx_mobile] ON [userInfoBDB] ([mobile] ASC);
CREATE INDEX [idx_userIP_userInfoDB] ON [userInfoDB] ([userIP] ASC);
CREATE INDEX [idx_accountIDX_userItemDB] ON [userItemDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userItemDB] ON [userItemDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userItemEtcDB] ON [userItemEtcDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userItemEtcDB] ON [userItemEtcDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userItemMedalDB] ON [userItemMedalDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userItemMedalDB] ON [userItemMedalDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userItemMedalExtendDB] ON [userItemMedalExtendDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userItemMedalExtendDB] ON [userItemMedalExtendDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userLeagueAuthDB] ON [userLeagueAuthDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userLeagueAuthDB] ON [userLeagueAuthDB] ([idx] ASC);
CREATE INDEX [idx_leagueIDX] ON [userLeagueAuthDB] ([leagueIDX] ASC);
CREATE INDEX [idx_accountIDX_userLeagueCheerDB] ON [userLeagueCheerDB] ([accountIDX] ASC);
CREATE INDEX [idx_leagueIDX_userLeagueCheerDB] ON [userLeagueCheerDB] ([leagueIDX] ASC);
CREATE INDEX [idx_idx_userLeagueInfoDB] ON [userLeagueInfoDB] ([idx] ASC);
CREATE INDEX [idx_leagueIDX_userLeagueInfoDB] ON [userLeagueInfoDB] ([leagueIDX] ASC);
CREATE INDEX [idx_accountIDX_userLeagueListDB] ON [userLeagueListDB] ([accountIDX] ASC);
CREATE INDEX [idx_accountIDX_userLeagueRewardCheerDB] ON [userLeagueRewardCheerDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userLeagueRewardCheerDB] ON [userLeagueRewardCheerDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userLeagueRewardDB] ON [userLeagueRewardDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userLeagueRewardDB] ON [userLeagueRewardDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userLeagueRewardUserDB] ON [userLeagueRewardUserDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userLeagueRewardUserDB] ON [userLeagueRewardUserDB] ([idx] ASC);
CREATE INDEX [idx_regDate] ON [userLeagueRewardUserDB] ([regDate] ASC);
CREATE INDEX [idx_idx_userLeagueRoundDB] ON [userLeagueRoundDB] ([idx] ASC);
CREATE INDEX [idx_infoIDX] ON [userLeagueRoundDB] ([infoIDX] ASC);
CREATE INDEX [idx_leaderIDX] ON [userLeagueTeamDB] ([leaderIDX] ASC);
CREATE INDEX [idx_leagueIDX_userLeagueTeamDB] ON [userLeagueTeamDB] ([leagueIDX] ASC);
CREATE INDEX [idx_accountIDX_userLeagueTeamMemberDB] ON [userLeagueTeamMemberDB] ([accountIDX] ASC);
CREATE INDEX [idx_leagueIDX_userLeagueTeamMemberDB] ON [userLeagueTeamMemberDB] ([leagueIDX] ASC);
CREATE INDEX [idx_teamIDX] ON [userLeagueTeamMemberDB] ([teamIDX] ASC);
CREATE INDEX [idx_endDate] ON [userLeagueWinnerHistoryDB] ([endDate] ASC);
CREATE INDEX [idx_idx_userLeagueWinnerHistoryDB] ON [userLeagueWinnerHistoryDB] ([idx] ASC);
CREATE INDEX [idx_startDate] ON [userLeagueWinnerHistoryDB] ([startDate] ASC);
CREATE INDEX [idx_accountIDX_userLeagueWinnerInfoDB] ON [userLeagueWinnerInfoDB] ([accountIDX] ASC);
CREATE INDEX [idx_historyIDX] ON [userLeagueWinnerInfoDB] ([historyIDX] ASC);
CREATE INDEX [idx_idx_userLeagueWinnerInfoDB] ON [userLeagueWinnerInfoDB] ([idx] ASC);
CREATE INDEX [idx_gameserverID] ON [userLoginDB] ([gameServerID] ASC);
CREATE INDEX [idx_accountIDX_userMedalDB] ON [userMedalDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userMedalDB] ON [userMedalDB] ([idx] ASC);
CREATE INDEX [idx_acc_medalIDX] ON [userMedalDB_receive] ([accountIDX] ASC, [medalIDX] ASC);
CREATE INDEX [idx_accountIDX_userMedalDB_receive] ON [userMedalDB_receive] ([accountIDX] ASC);
CREATE INDEX [idx_accountIDX_userMemberDB] ON [userMemberDB] ([accountIDX] ASC);
CREATE INDEX [idx_email] ON [userMemberDB] ([email] ASC);
CREATE UNIQUE INDEX [UK_userMemberDB] ON [userMemberDB] ([nickName] ASC);
CREATE INDEX [idx_jumin] ON [userNameDB] ([userJumin1] ASC, [userJumin2] ASC);
CREATE INDEX [idx_userencode] ON [userNameDB] ([userEnCode] ASC);
CREATE INDEX [idx_userName] ON [userNameDB] ([userName] ASC);
CREATE INDEX [idx_userOAuthDB_accountIDX] ON [userOAuthDB] ([accountIDX] ASC);
CREATE UNIQUE INDEX [UK_userOAuthDB_provider_user] ON [userOAuthDB] ([provider] ASC, [providerUserID] ASC);
CREATE INDEX [idx_parentencode] ON [userParentDB] ([parentEncode] ASC);
CREATE INDEX [ncx_userPersonalHQDB_ItemSerial] ON [userPersonalHQDB] ([ItemSerial] ASC);
CREATE INDEX [idx_accountIDX_userPieceDB] ON [userPieceDB] ([accountIDX] ASC);
CREATE INDEX [NCI_userPracticeDB_Ranking] ON [userPracticeDB_Ranking] ([AccountIDX] ASC, [PracticeIDX] ASC);
CREATE INDEX [idx_idx_userPresentDB] ON [userPresentDB] ([idx] ASC);
CREATE INDEX [idx_receiveIDX] ON [userPresentDB] ([receiveIDX] ASC);
CREATE INDEX [idx_accountIDX_userQuestCompleteDB] ON [userQuestCompleteDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userQuestCompleteDB] ON [userQuestCompleteDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userQuestDB] ON [userQuestDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userQuestDB] ON [userQuestDB] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userRankingDB_award] ON [userRankingDB_award] ([accountIDX] ASC);
CREATE INDEX [idx_awardType] ON [userRankingDB_award_top3] ([awardType] ASC);
CREATE INDEX [idx_dateIDX] ON [userRankingDB_award_top3] ([dateIDX] ASC);
CREATE INDEX [idx_accountIDX_userRankingDB_class] ON [userRankingDB_class] ([accountIDX] ASC);
CREATE INDEX [idx_classType] ON [userRankingDB_class] ([classType] ASC);
CREATE INDEX [idx_nowRanking] ON [userRankingDB_class] ([nowRanking] ASC);
CREATE INDEX [idx_classType_userRankingDB_class_top100] ON [userRankingDB_class_top100] ([classType] ASC);
CREATE INDEX [idx_guildIDX_userRankingDB_class_top100] ON [userRankingDB_class_top100] ([guildIDX] ASC);
CREATE INDEX [idx_idx_userRankingDB_class_top100] ON [userRankingDB_class_top100] ([idx] ASC);
CREATE INDEX [idx_classType_userRankingDB_class_top3] ON [userRankingDB_class_top3] ([classType] ASC);
CREATE INDEX [idx_dateIDX_userRankingDB_class_top3] ON [userRankingDB_class_top3] ([dateIDX] ASC);
CREATE INDEX [idx_accountIDX_userRankingDB_classgroup] ON [userRankingDB_classgroup] ([accountIDX] ASC);
CREATE INDEX [idx_ranking1day] ON [userRankingDB_classgroup] ([ranking_1day] ASC);
CREATE INDEX [idx_userLevel] ON [userRankingDB_classgroup] ([userLevel] ASC);
CREATE INDEX [idx_accountIDX_userRankingDB_classgroup_top10000] ON [userRankingDB_classgroup_top10000] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userRankingDB_classgroup_top10000] ON [userRankingDB_classgroup_top10000] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userRankingDB_hero] ON [userRankingDB_hero] ([accountIDX] ASC);
CREATE INDEX [idx_daily] ON [userRankingDB_hero] ([daily] ASC);
CREATE INDEX [idx_accountIDX_userRankingDB_medal] ON [userRankingDB_medal] ([accountIDX] ASC);
CREATE INDEX [idx_expert] ON [userRankingDB_temp_expert] ([expert] ASC);
CREATE INDEX [idx_accountIDX_userRegionDB_compen] ON [userRegionDB_compen] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userRegionDB_compen] ON [userRegionDB_compen] ([idx] ASC);
CREATE INDEX [idx_accountIDX_userSBoxDB] ON [userSBoxDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userSBoxDB] ON [userSBoxDB] ([idx] ASC);
CREATE INDEX [NC_userSpiritDB_AccountIDX] ON [userSpiritDB] ([AccountIDX] ASC, [idx] ASC);
CREATE INDEX [idx_accountIDX_userTradeDB] ON [userTradeDB] ([accountIDX] ASC);
CREATE INDEX [idx_idx_userTradeDB] ON [userTradeDB] ([idx] ASC);
