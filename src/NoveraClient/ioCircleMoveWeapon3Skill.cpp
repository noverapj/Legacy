...
ioCircleMoveWeapon3Skill::ioCircleMoveWeapon3Skill()
{
	ClearData();
}

ioCircleMoveWeapon3Skill::ioCircleMoveWeapon3Skill( const ioCircleMoveWeapon3Skill &rhs )
	: ioNormalSkill( rhs ),
...
void ioCircleMoveWeapon3Skill::LoadProperty( ioINILoader &rkLoader )
{
...
void ioCircleMoveWeapon3Skill::ClearData()
{
	m_State = SS_NONE;
...
ioSkill* ioCircleMoveWeapon3Skill::Clone()
{
	return new ioCircleMoveWeapon3Skill( *this );
}

bool ioCircleMoveWeapon3Skill::OnSkillStart( ioBaseChar *pChar )
{	
	if( !HasSkillMotion() )
		return false;
...
void ioCircleMoveWeapon3Skill::OnSkillEnd( ioBaseChar *pChar )
{
...
void ioCircleMoveWeapon3Skill::OnProcessState( ioBaseChar *pChar, ioPlayStage *pStage )
{
...
void ioCircleMoveWeapon3Skill::ApplyAttributeToWeapon( ioWeapon *pWeapon, ioPlayStage *pStage )
{
...
void ioCircleMoveWeapon3Skill::ApplyExtraSkillInfo( ioBaseChar *pChar, ioPlayStage *pStage, SP2Packet &rkPacket )
{
	if( !pChar || !pStage ) 
		return;
...
bool ioCircleMoveWeapon3Skill::CheckUseItemMesh()
{
	return m_bUseItemMesh;
}


bool ioCircleMoveWeapon3Skill::IsProtected( int iDefenseBreakType ) const
{
...
bool ioCircleMoveWeapon3Skill::StartPreDelayAnimation( ioBaseChar *pChar )
{
...
void ioCircleMoveWeapon3Skill::SetPreAction( ioBaseChar *pChar )
{
	EndPreDelayEffect( pChar );
...
void ioCircleMoveWeapon3Skill::SetNormalSkill( ioBaseChar *pChar )
{
	ioEntityGroup *pGrp = pChar->GetGroup();
...
void ioCircleMoveWeapon3Skill::SetLoopState( ioBaseChar *pChar, ioPlayStage *pStage )
{
	m_State = SS_LOOP;
...
void ioCircleMoveWeapon3Skill::SetEndState( ioBaseChar *pChar )
{
	m_State = SS_END;
...
void ioCircleMoveWeapon3Skill::OnLoopState( ioBaseChar *pChar, ioPlayStage *pStage )
{
	// 뱡향 변화 체크
...
void ioCircleMoveWeapon3Skill::UpdateCircle( ioBaseChar *pOwner )
{
	if( !pOwner ) return;
...
void ioCircleMoveWeapon3Skill::AttackFire( ioBaseChar *pChar )
{
...
float ioCircleMoveWeapon3Skill::GetFlightDuration( float fCurGravity, float fCurWeaponFloatPower, float fGapHeight )
{
...
float ioCircleMoveWeapon3Skill::GetTargetTime( IN float fCurGravity, IN float fGapHeight, OUT float &fFloatPower )
{
	float fGapTime = 0.0f;
...
void ioCircleMoveWeapon3Skill::CheckWeaponFloatInfo( ioBaseChar *pChar )
{
	// CharDir
...
void ioCircleMoveWeapon3Skill::GenerateEndAttack( const D3DXVECTOR3 &vPos, ioBaseChar *pOwner )
{
	if( !pOwner )	return;
...
bool ioCircleMoveWeapon3Skill::IsEndState() const
{
	if( m_State == SS_END )
		return true;
...
bool ioCircleMoveWeapon3Skill::IsNoDropState() const
{
...
bool ioCircleMoveWeapon3Skill::IsAttackEndState() const
{
	return IsEndState();
}


bool ioCircleMoveWeapon3Skill::IsSkillMotionEnd( DWORD dwActionStop, ioBaseChar* pOwner ) const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//추가 yong jun
void ioCircleMoveWeapon3Skill::LoadMagicCircleWeaponInfo( ioINILoader &rkLoader )
{
...
void ioCircleMoveWeapon3Skill::CheckRotate( ioBaseChar *pChar )
{
	if ( !pChar )
		return;
...
void ioCircleMoveWeapon3Skill::MagicCircleFire( ioBaseChar *pChar )
{
...
void ioCircleMoveWeapon3Skill::RemoveWeapon( ioBaseChar *pChar )
{
...
void ioCircleMoveWeapon3Skill::CheckWeapon( ioBaseChar *pChar )
{
	ioWeapon* pWeapon = g_WeaponMgr.FindWeapon( pChar, m_dwSingleWeaponIdx );
	if ( !pWeapon)
		return;
...
void ioCircleMoveWeapon3Skill::AttackSingleFire( ioBaseChar *pChar )
{
	//한번만 들어오는 함수.
...
bool ioCircleMoveWeapon3Skill::CheckInputAttack( ioBaseChar *pOwner )
{
...
void ioCircleMoveWeapon3Skill::CreateWeapon( ioBaseChar *pOwner )
{
	if ( !pOwner )
		return;
...
void ioCircleMoveWeapon3Skill::SetEndStatePacket( ioBaseChar *pOwner )
{
	if ( !pOwner || !pOwner->IsNeedProcess() )
		return;
...
void ioCircleMoveWeapon3Skill::CreateAreaWeapon( ioBaseChar *pOwner, ioPlayStage *pStage )
{
...
void ioCircleMoveWeapon3Skill::SetCreateAreaWeaponState( ioBaseChar *pOwner, const AttackAttribute& Attribute )
{
	if ( !pOwner )
		return;
