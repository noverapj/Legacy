...
{	
	...
	StringCbCopy( m_szMacro[MACRO_GROWTH_LEVELUP]				,sizeof( m_szMacro[MACRO_GROWTH_LEVELUP] )				, STR(45) );
	StringCbCopy( m_szMacro[MACRO_MONSTER_CLOSE]				,sizeof( m_szMacro[MACRO_MONSTER_CLOSE] )				, "/MonsterClose" );
	StringCbCopy( m_szMacro[MACRO_BINGO_PRESENT]				,sizeof( m_szMacro[MACRO_BINGO_PRESENT] )				, STR(46) );
	StringCbCopy( m_szMacro[MACRO_MONSTER_SPAWN]				,sizeof( m_szMacro[MACRO_MONSTER_SPAWN] )				, STR(47) );
	StringCbCopy( m_szMacro[MACRO_SUPERGASHAPON_GET_ALL]		,sizeof( m_szMacro[MACRO_SUPERGASHAPON_GET_ALL] )		, STR(48) );
	StringCbCopy( m_szMacro[MACRO_SUPERGASHAPON_GET]			,sizeof( m_szMacro[MACRO_SUPERGASHAPON_GET] )			, STR(49) );
	StringCbCopy( m_szMacro[MACRO_SUPERGASHAPON_LIMIT_INFO_GET]	,sizeof( m_szMacro[MACRO_SUPERGASHAPON_LIMIT_INFO_GET] ), STR(50) );
	StringCbCopy( m_szMacro[MACRO_SUPERGASHAPON_LIMIT_RESET]	,sizeof( m_szMacro[MACRO_SUPERGASHAPON_LIMIT_RESET] )	, STR(51) );
	StringCbCopy( m_szMacro[MACRO_SEND_RECIVE_CHECK_ON]			,sizeof( m_szMacro[MACRO_SEND_RECIVE_CHECK_ON] )		, STR(52) );
	StringCbCopy( m_szMacro[MACRO_SEND_RECIVE_CHECK_OFF]		,sizeof( m_szMacro[MACRO_SEND_RECIVE_CHECK_OFF] )		,STR(53) );
	StringCbCopy( m_szMacro[MACRO_ATTENDANCE_WND_SHOW]			,sizeof( m_szMacro[MACRO_ATTENDANCE_WND_SHOW] )			, STR(54) );
	StringCbCopy( m_szMacro[MACRO_ATTENDANCE_ADD_DAY]			,sizeof( m_szMacro[MACRO_ATTENDANCE_ADD_DAY] )			, STR(55) );
	StringCbCopy( m_szMacro[MACRO_ATTENDANCE_ADD_PREV_MONTH]	,sizeof( m_szMacro[MACRO_ATTENDANCE_ADD_PREV_MONTH] )	, STR(56) );
	StringCbCopy( m_szMacro[MACRO_ATTENDANCE_RESET]				,sizeof( m_szMacro[MACRO_ATTENDANCE_RESET] )			, STR(57) );
	StringCbCopy( m_szMacro[MACRO_ATTENDANCE_SET_DATE]			,sizeof( m_szMacro[MACRO_ATTENDANCE_SET_DATE] )			, STR(58) );
	StringCbCopy( m_szMacro[MACRO_AWAKE_SET_DATE]				,sizeof( m_szMacro[MACRO_AWAKE_SET_DATE] )				, STR(59) );
	StringCbCopy( m_szMacro[MACRO_GASHAPON_GET_ALL]				,sizeof( m_szMacro[MACRO_GASHAPON_GET_ALL] )			, "/GetGashaAll" );
	StringCbCopy( m_szMacro[MACRO_CHAR_POWER_UP_ADD]			,sizeof( m_szMacro[MACRO_CHAR_POWER_UP_ADD] )			, STR(60) );
	StringCbCopy( m_szMacro[MACRO_ITEM_SLOT_INDEX_FIND]			,sizeof( m_szMacro[MACRO_ITEM_SLOT_INDEX_FIND] )		, STR(61) );
	StringCbCopy( m_szMacro[MACRO_ITEM_POWER_UP_ADD]			,sizeof( m_szMacro[MACRO_ITEM_POWER_UP_ADD] )			, STR(62) );
	...
	StringCbCopy( m_szMacro[MACRO_CHAR_INFO_WND_SHOW]			,sizeof( m_szMacro[MACRO_CHAR_INFO_WND_SHOW] )			, STR(63) );
	StringCbCopy( m_szMacro[MACRO_SET_MISSION]					,sizeof( m_szMacro[MACRO_SET_MISSION] )					, STR(64) );
	StringCbCopy( m_szMacro[MACRO_SET_DATE_MISSION]				,sizeof( m_szMacro[MACRO_SET_DATE_MISSION] )			, STR(65) );
	StringCbCopy( m_szMacro[MACRO_SET_MISSION_VALUE]			,sizeof( m_szMacro[MACRO_SET_MISSION_VALUE] )			, STR(66) );
	StringCbCopy( m_szMacro[MACRO_ROLLBOOK_WND_SHOW]			,sizeof( m_szMacro[MACRO_ROLLBOOK_WND_SHOW] )			, STR(67) );
	StringCbCopy( m_szMacro[MACRO_ROLLBOOK_PROGRESS]			,sizeof( m_szMacro[MACRO_ROLLBOOK_PROGRESS] )			, STR(68) );
	...
	StringCbCopy( m_szMacro[MACRO_COMFORTABLE_LIFE]				,sizeof( m_szMacro[MACRO_COMFORTABLE_LIFE] )			, STR(69) );
	StringCbCopy( m_szMacro[MACRO_TOURNAMENT_NEXT_STATE]		,sizeof( m_szMacro[MACRO_TOURNAMENT_NEXT_STATE] )		, STR(70) );
	StringCbCopy( m_szMacro[MACRO_TOURNAMENT_RESULT]			,sizeof( m_szMacro[MACRO_TOURNAMENT_RESULT] )			, STR(71) );
	StringCbCopy( m_szMacro[MACRO_SHOW_POPUP]					,sizeof( m_szMacro[MACRO_SHOW_POPUP] )					, "/popup" );
	StringCbCopy( m_szMacro[MACRO_PRACTICE_COMPLETE]			,sizeof( m_szMacro[MACRO_PRACTICE_COMPLETE] )				, STR(72));
}
