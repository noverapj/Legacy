...
class ioContactWeapon2 : public ioWeapon
{
protected:
...
public:
	ioContactWeapon2( ioBaseChar *pOwner, const WeaponAttribute *pAttr );
	virtual ~ioContactWeapon2();
};

inline ioContactWeapon2* ToContactWeapon2( ioWeapon *pWeapon )
{
	if( !pWeapon || pWeapon->GetType() != ioWeapon::WT_CONTACT2 )
		return NULL;

	return dynamic_cast< ioContactWeapon2* >( pWeapon );
}
