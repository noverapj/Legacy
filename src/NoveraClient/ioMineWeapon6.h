...
class ioMineWeapon6 : public ioWeapon
{
protected:
	...
	ioHashString m_BlueMineEffect;
	ioHashString m_RedMineEffect;
...
public:
	...
	MineState GetMineState(){ return m_State; }
...
public:
	...
	void SetSilenceDeadMine( ioPlayStage *pStage, bool bSendNetwork );
...
protected:
	...
	void OnNormalDead( ioPlayStage *pStage );
...
public:
	ioMineWeapon6( ioBaseChar *pOwner, const WeaponAttribute *pAttr );
	virtual ~ioMineWeapon6();

	//////////////////////////////////////////////////////////////////////////
	int GetNeedGauge();
	bool CheckEnableUpgradeState();
};

inline ioMineWeapon6* ToMineWeapon6( ioWeapon *pWeapon )
{
	if( !pWeapon || pWeapon->GetType() != ioWeapon::WT_MINE6 )
		return NULL;

	return dynamic_cast< ioMineWeapon6* >( pWeapon );
}
