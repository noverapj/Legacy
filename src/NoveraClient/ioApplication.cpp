...
bool ioApplication::SetupNetwork(const ioHashString& szGameServerIP, int iGameServerPort)
{
...
bool ioApplication::SetupBeforeLogin()
{
	ioINILoader_e kLoader( "config/sp2.ini" );
...
bool ioApplication::ProcessOptions(bool bUsePack, bool bSingle)
{
	if( m_pLogin )
		return m_pLogin->ProcessOptions(bUsePack, bSingle);
