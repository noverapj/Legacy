...
class ioMultiArea3Skill : public ioNormalSkill
{
public:
	enum SkillState
	{
...
public:
	ioMultiArea3Skill();
	ioMultiArea3Skill( const ioMultiArea3Skill &rhs );
	virtual ~ioMultiArea3Skill();
};

inline ioMultiArea3Skill* ToMultiArea3Skill( ioSkill *pSkill )
{
	ioNormalSkill *pNormal = ToNormalSkill( pSkill );
	if( !pNormal || pNormal->GetSubSkillType() != NST_MULTI_AREA3 )
		return NULL;

	return dynamic_cast< ioMultiArea3Skill* >( pSkill );
}
