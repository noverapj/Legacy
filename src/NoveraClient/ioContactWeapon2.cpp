...
ActionStopType ioContactWeapon2::m_ActionStopType = AST_NONE;
ActionStopType ioContactWeapon2::m_DieActionStopType = AST_NONE;

ioContactWeapon2::ioContactWeapon2( ioBaseChar *pOwner, const WeaponAttribute *pAttr )
...
ioContactWeapon2::~ioContactWeapon2()
{
}

void ioContactWeapon2::LoadProperty( ioINILoader &rkLoader )
{
...
void ioContactWeapon2::SetStartCollisionBox()
{
...
void ioContactWeapon2::StartCollisionBoxByOwner()
{
...
void ioContactWeapon2::StartCollisionBoxByStruct()
{
	ioPushStruct *pPush = g_PushStructListMgr.FindPushStruct( m_iStructIndex );
	if( pPush )
	{
...
void ioContactWeapon2::StartCollisionBoxByDummyChar()
{
	ioDummyChar *pDummy = g_DummyCharMgr.FindDummyChar( GetOwner(), m_iDummyIndex );
	if( pDummy )
	{
...
void ioContactWeapon2::GetWorldAttackBoxList( std::vector< ioOrientBox > &vBoxList )
{
	vBoxList.reserve( 3 );
...
bool ioContactWeapon2::IsCollision( ioPlayEntity *pEntity, bool bMapCollision )
{
...
bool ioContactWeapon2::CheckCollisionLine( ioPlayEntity *pTarget, const D3DXVECTOR3 &vColPoint )
{
...
ioWeapon::WeaponType ioContactWeapon2::GetType() const
{
	return WT_CONTACT2;
}

ActionStopType ioContactWeapon2::GetActionStopType() const
{
	return m_ActionStopType;
}

ActionStopType ioContactWeapon2::GetDieActionStopType() const
{
	return m_DieActionStopType;
}

void ioContactWeapon2::UpdateWorldAttackBox( float fTimePerSec, bool bSetNull )
{
	if( m_bStructWeapon )
...
void ioContactWeapon2::UpdateAttackBoxByOwner( float fTimePerSec, bool bSetNull )
{
	ioBaseChar *pOwner = GetOwner();
...
void ioContactWeapon2::UpdateAttackBoxByStruct( float fTimePerSec, bool bSetNull )
{
	ioPushStruct *pPush = g_PushStructListMgr.FindPushStruct( m_iStructIndex );
...
void ioContactWeapon2::UpdateAttackBoxByDummyChar( float fTimePerSec, bool bSetNull )
{
	ioDummyChar *pDummy = g_DummyCharMgr.FindDummyChar( GetOwner(), m_iDummyIndex );
...
void ioContactWeapon2::Process( float fTimePerSec, ioPlayStage *pStage )
{
	DWORD dwCurTime = FRAMEGETTIME();
...
void ioContactWeapon2::StartCollisionBoxByMachine()
{
	ioMachineStruct *pMachine = g_MachineStructMgr.FindMachineStruct( m_iMachineIndex );
	if( pMachine )
	{
	...
	{
		m_WorldAttackBox.SetNull();
		LOG.PrintTimeAndLog( 0, "ioContactWeapon2 - Machine Not Exist" );
	}

	m_UpdateState = CONTACT_CREATED;
}

void ioContactWeapon2::UpdateAttackBoxByMachine( float fTimePerSec, bool bSetNull )
{
	ioMachineStruct *pMachine = g_MachineStructMgr.FindMachineStruct( m_iMachineIndex );
