...
class ioRunningAttackSkill : public ioAttackSkill
{
public:
	enum RunningState
	{
...
public:
	ioRunningAttackSkill();
	ioRunningAttackSkill( const ioRunningAttackSkill &rhs );
	virtual ~ioRunningAttackSkill();
};

inline ioRunningAttackSkill* ToRunningAttackSkill( ioSkill *pSkill )
{
	ioAttackSkill *pAttack = ToAttackSkill( pSkill );
	if( !pAttack || pAttack->GetSubSkillType() != AST_RUNNING_ATTACK )
		return NULL;

	return dynamic_cast< ioRunningAttackSkill* >( pAttack );
}
