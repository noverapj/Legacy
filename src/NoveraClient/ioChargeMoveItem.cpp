...
ioChargeMoveItem::ioChargeMoveItem()
{
...
ioChargeMoveItem::ioChargeMoveItem( const ioChargeMoveItem &rhs )
: ioWeaponItem( rhs ),
...
void ioChargeMoveItem::LoadProperty( ioINILoader &rkLoader )
{
...
ioItem* ioChargeMoveItem::Clone()
{
	return new ioChargeMoveItem( *this );
}

ioWeaponItem::WeaponSubType ioChargeMoveItem::GetSubType() const
{
	return WST_CHARGE_MOVE;
}

void ioChargeMoveItem::ClearState()
{
	m_ChargeState = CS_NONE;
	m_SubChargeState = SCS_NONE;
...
void ioChargeMoveItem::SetNormalAttack( ioBaseChar *pOwner, int iCurCombo )
{
	if( !pOwner ) return;
...
void ioChargeMoveItem::CheckNormalAttack( ioBaseChar *pOwner )
{
...
void ioChargeMoveItem::OnCharging( ioBaseChar *pOwner )
{
...
void ioChargeMoveItem::OnGathering( ioBaseChar *pOwner )
{
...
void ioChargeMoveItem::OnChargeFire( ioBaseChar *pOwner )
{
	DWORD dwCurTime = FRAMEGETTIME();
	DWORD dwLooseTime = 0;
	if( pOwner )
...
void ioChargeMoveItem::OnEndState( ioBaseChar *pOwner )
{
	DWORD dwCurTime = FRAMEGETTIME();
...
void ioChargeMoveItem::ProcessChargeMoveWait( ioBaseChar *pOwner )
{
	...
	if( m_dwGatheringStartTime+m_dwChargeMoveDuration < dwCurTime )
	{
		ChangeToAttackFire( pOwner );
		return;
	}
...
void ioChargeMoveItem::ProcessChargeMoveAction( ioBaseChar *pOwner )
{
	DWORD dwCurTime = FRAMEGETTIME();
	...
	if( m_dwChargeMoveForceEndTime > 0 && m_dwChargeMoveForceEndTime < dwCurTime )
	{
		...
		// 종료
		if( pOwner && pOwner->IsNeedProcess() &&
			m_dwGatheringStartTime+m_dwChargeMoveDuration < dwCurTime )
		{
			ChangeToAttackFire( pOwner );
			return;
		}
...
void ioChargeMoveItem::ChangeToGathering( ioBaseChar *pOwner )
{
...
void ioChargeMoveItem::SetChargeMoveWait( ioBaseChar *pOwner )
{
	ioEntityGroup *pGrp = pOwner->GetGroup();
	pGrp->ClearAllActionAni( FLOAT100, true );
	pGrp->ClearAllLoopAni( FLOAT100, true );
	...
	pGrp->SetLoopAni( m_ChargeMoveWaitAni, FLOAT100, FLOAT1, FLOAT1/fCurRate );

	m_SubChargeState = SCS_WAIT;
}

void ioChargeMoveItem::ChangeToNormalAttack( ioBaseChar *pOwner )
{
	pOwner->SetChargingState( false );
...
void ioChargeMoveItem::ChangeToAttackFire( ioBaseChar *pOwner )
{
	DWORD dwCurTime = FRAMEGETTIME();
...
void ioChargeMoveItem::ChangeToEndState( ioBaseChar *pOwner )
{
...
void ioChargeMoveItem::SetChargeMoveAction( ioBaseChar *pOwner, const ioHashString &szAni, float fAniRate, D3DXVECTOR3 vDir )
{
	if( !pOwner ) return;
	ioEntityGroup *pGrp = pOwner->GetGroup();
	if( !pGrp ) return;
...
void ioChargeMoveItem::OnItemGaugeOK( ioBaseChar *pOwner, SP2Packet &rkPacket )
{
	int iSyncState;
	rkPacket >> iSyncState;
...
void ioChargeMoveItem::SetExtraInfoToWeapon( ioWeapon *pWeapon, bool bJumpAttack )
{
...
bool ioChargeMoveItem::IsChargeAttackState( ioBaseChar *pOwner )
{
...
bool ioChargeMoveItem::IsNoGhostWalk( ioBaseChar *pOwner )
{
...
bool ioChargeMoveItem::IsEnableAttackDashCheck( ioBaseChar *pOwner, bool bCheck )
{
...
void ioChargeMoveItem::OnEndExtendAttack( ioBaseChar *pOwner, bool bReleaseItem )
{
	pOwner->SetChargingState( false );
	m_fCurChargeRate = 0.0f;
}

bool ioChargeMoveItem::IsChargeAutoTarget( ioBaseChar *pOwner )
{
	if( !pOwner )
		return false;
...
void ioChargeMoveItem::GetAutoTargetValue( ioBaseChar *pOwner,
...
float ioChargeMoveItem::GetChargeDamageRateForSkill()
{
...
float ioChargeMoveItem::GetChargeForceRateForSkill()
{
...
float ioChargeMoveItem::GetChargeBlowRateForSkill()
{
...
float ioChargeMoveItem::GetChargeRangeRateForSkill()
{
...
float ioChargeMoveItem::GetChargeSpeedRateForSkill()
{
...
float ioChargeMoveItem::GetChargeFloatRateForSkill()
{
...
float ioChargeMoveItem::GetChargeScaleRateForSkill()
{
...
float ioChargeMoveItem::GetChargeExplosionRateForSkill()
{
...
void ioChargeMoveItem::ClearCurChargeRateForSkill()
{
	m_fCurChargeRate = 0.0f;
	m_fCurChargeRateForSkill = 0.0f;
}

void ioChargeMoveItem::SetFireMotion( ioBaseChar *pOwner )
{
	DWORD dwCurTime = FRAMEGETTIME();
...
void ioChargeMoveItem::SetAttackByAttribute( ioBaseChar *pOwner, const AttackAttribute &rkAttr, float fExtraAniRate, float fExtraForceRate )
{
	ioEntityGroup *pGrp = pOwner->GetGroup();
	if( !pGrp ) return;
...
bool ioChargeMoveItem::CheckChargeMove( ioBaseChar *pOwner )
{
...
void ioChargeMoveItem::CheckReserve( ioBaseChar *pOwner )
{
