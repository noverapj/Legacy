...
class ioChargeMoveItem2 : public ioWeaponItem
{
public:
	enum ChargeState
	{
...
public:
	ioChargeMoveItem2();
	ioChargeMoveItem2( const ioChargeMoveItem2 &rhs );
	virtual ~ioChargeMoveItem2();
};

inline ioChargeMoveItem2* ToChargeMoveItem2( ioItem *pItem )
{
	ioWeaponItem *pWeapon = ToWeaponItem( pItem );
	if( !pWeapon || pWeapon->GetSubType() != ioWeaponItem::WST_CHARGE_MOVE2 )
		return NULL;

	return dynamic_cast< ioChargeMoveItem2* >( pItem );
}
