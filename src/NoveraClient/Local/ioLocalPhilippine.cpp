...
DWORD ioLocalPhilippine::GetResourceIDTitleCashBmp()
{
	return IDB_WEB_TITLE_CASH;
}

DWORD ioLocalPhilippine::GetResourceIDTitleEntryBmp()
{
	return IDB_WEB_TITLE_ENTRY;
}

DWORD ioLocalPhilippine::GetResourceIDTitleGuildBmp()
{
	return IDB_WEB_TITLE_GUILD;
}

DWORD ioLocalPhilippine::GetResourceIDTitleGuildMarkBmp()
{
	return IDB_WEB_TITLE_GUILD_MARK;
}

DWORD ioLocalPhilippine::GetResourceIDTitleHomeBmp()
{
	return IDB_WEB_TITLE_HOME;
}

DWORD ioLocalPhilippine::GetResourceIDTitleBmp()
{
	return IDB_WINDOW_TITLE_LOSA;
}

void ioLocalPhilippine::SetLoginData( const ioHashString &szBillingUserKey )
{
...
const char * ioLocalPhilippine::GetGuildAdminPosition()
{
	return "Member"; //Except Extracting Hangeul
}
...
void ioLocalPhilippine::GetChangedString( OUT char *szCheckString )
{
...
bool ioLocalPhilippine::IsShowRegulation()
{
	return false;
}

DWORD ioLocalPhilippine::GetResourceIDErrorBack()
{
	return IDB_BACK_ERROR_PLP;
}

DWORD ioLocalPhilippine::GetResourceIDErrorExitC()
{
	return IDB_EXIT_C_PLP;
}

DWORD ioLocalPhilippine::GetResourceIDErrorExitN()
{
	return IDB_EXIT_N_PLP;
}

DWORD ioLocalPhilippine::GetResourceIDErrorExitO()
{
	return IDB_EXIT_O_PLP;
}

DWORD ioLocalPhilippine::GetResourceIDErrorSolutionC()
{
	return IDB_SOLUTION_C_PLP;
}

DWORD ioLocalPhilippine::GetResourceIDErrorSolutionN()
{
	return IDB_SOLUTION_N_PLP;
}

DWORD ioLocalPhilippine::GetResourceIDErrorSolutionO()
{
...
void ioLocalPhilippine::OnCashPageHide()
{
