...
enum DATA_ITEM_TYPE
{
	...
	DATA_ITEM_TYPE_COSTUM        = 16,
    DATA_ITEM_TYPE_MAX           = 17
};
...
{
	PET_OK						= 0,	// 정상
	PET_INDEX_DUPLICATED		= 1,	// 팻 인덱스 중복
	PET_INDEX_NOTHING			= 2,	// 팻 인덱스가 없다
	PET_LIST_EMPTY				= 3,	// 팻 리스트가 비어 있다
	PET_UPGRADE_CODE_NOTHING	= 4,	// 팻 업그레이드 코드가 없다
	PET_FOOD_CODE_NOTHING		= 5,	// 팻 먹이 코드가 없다
	PET_FOOD_TYPE_ERR			= 6,	// 팻 먹이 타입이 잘못되었다
};
