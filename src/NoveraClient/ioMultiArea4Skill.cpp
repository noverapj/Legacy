...
ioMultiArea4Skill::ioMultiArea4Skill()
{
	ClearData();
}

ioMultiArea4Skill::ioMultiArea4Skill( const ioMultiArea4Skill &rhs )
: ioNormalSkill( rhs ),
...
void ioMultiArea4Skill::ClearData()
{
	m_dwCurMapEffect = -1;
...
void ioMultiArea4Skill::LoadProperty( ioINILoader &rkLoader )
{
...
void ioMultiArea4Skill::LoadOwnerBuffList( ioINILoader &rkLoader )
{
...
ioSkill* ioMultiArea4Skill::Clone()
{
	return new ioMultiArea4Skill( *this );
}

bool ioMultiArea4Skill::OnSkillStart( ioBaseChar *pChar )
{
	/*if( !HasSkillMotion() )
		return false;*/
	...
	{
		m_iCurActiveCount = GetMaxActiveCount( pChar );
	}
...
void ioMultiArea4Skill::OnSkillEnd( ioBaseChar *pChar )
{
	...
	pChar->SetConveyerDisable( false );
...
void ioMultiArea4Skill::OnProcessState( ioBaseChar *pChar, ioPlayStage *pStage )
{
...
bool ioMultiArea4Skill::StartPreDelayAnimation( ioBaseChar *pChar )
{
...
void ioMultiArea4Skill::CreateMagicCircle( ioBaseChar *pChar )
{
...
void ioMultiArea4Skill::UpdateMagicCircle( ioBaseChar *pChar )
{
	if( !pChar->CheckMagicCircle() )
		return;
...
void ioMultiArea4Skill::EndMagicCircle( ioBaseChar *pChar )
{
	if( m_iCurCombo > 0 )
		return;
...
void ioMultiArea4Skill::DestroyMagicCircle( ioBaseChar *pChar )
{
	pChar->SetMagicCircleTarget( "" );
	pChar->DestroyMagicCircle();
}

void ioMultiArea4Skill::SetNormalSkill( ioBaseChar *pChar )
{
	if( !COMPARE( m_iCurCombo, 0, m_iMaxCombo ) )
		return;
...
void ioMultiArea4Skill::SetSkillActionState( ioBaseChar *pChar, ioPlayStage *pStage )
{
...
void ioMultiArea4Skill::SetSkillTeleportState( ioBaseChar *pChar )
{
	if( !pChar )	return;
...
void ioMultiArea4Skill::SetSkillLoopState( ioBaseChar *pChar )
{
...
void ioMultiArea4Skill::SetSkillEndState( ioBaseChar *pChar )
{
	if( m_State == SS_END )
		return;
...
void ioMultiArea4Skill::ApplyExtraSkillInfo( ioBaseChar *pChar, ioPlayStage *pStage, SP2Packet &rkPacket )
{
	int iState;
	rkPacket >> iState;
	switch( iState )
...
bool ioMultiArea4Skill::IsEndState() const
{
	if( m_State == SS_END )
		return true;
...
bool ioMultiArea4Skill::IsProtected( int iDefenseBreakType ) const
{
...
bool ioMultiArea4Skill::IsSkillMotionEnd( DWORD dwActionStop, ioBaseChar* pOwner ) const
{
...
bool ioMultiArea4Skill::CheckUseItemMesh()
{
	return m_bUseItemMesh;
}

void ioMultiArea4Skill::ApplyAttributeToWeapon( ioWeapon *pWeapon, ioPlayStage *pStage )
{
...
void ioMultiArea4Skill::AddOwnerBuff( ioBaseChar *pChar )
{
	if( !pChar )	return;
...
void ioMultiArea4Skill::RemoveOwnerBuff( ioBaseChar *pChar )
{
	if( !pChar )	return;
	if( m_OwnerBuffList.empty() ) return;
	int iCnt = m_OwnerBuffList.size();
...
void ioMultiArea4Skill::RandomPosAttack( ioBaseChar *pChar )
{
	if ( !pChar ) return;
