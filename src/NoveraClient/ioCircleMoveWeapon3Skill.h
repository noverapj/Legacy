...
class ioCircleMoveWeapon3Skill : public ioNormalSkill
{
public:
	enum SkillState
	{
...
public:
	ioCircleMoveWeapon3Skill();
	ioCircleMoveWeapon3Skill( const ioCircleMoveWeapon3Skill &rhs );
	virtual ~ioCircleMoveWeapon3Skill();
};

inline ioCircleMoveWeapon3Skill* ToCircleMoveWeapon3Skill( ioSkill *pSkill )
{
	ioNormalSkill *pNormal = ToNormalSkill( pSkill );
	if( !pNormal || pNormal->GetSubSkillType() != NST_CIRCLE_MOVE_WEAPON3 )
		return NULL;

	return dynamic_cast< ioCircleMoveWeapon3Skill* >( pSkill );
}
