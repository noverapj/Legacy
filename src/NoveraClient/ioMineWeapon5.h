...
class ioMineWeapon5 : public ioWeapon
{
protected:
...
public:
	ioMineWeapon5( ioBaseChar *pOwner, const WeaponAttribute *pAttr );
	virtual ~ioMineWeapon5();
};

inline ioMineWeapon5* ToMineWeapon5( ioWeapon *pWeapon )
{
	if( !pWeapon || pWeapon->GetType() != ioWeapon::WT_MINE5 )
		return NULL;

	return dynamic_cast< ioMineWeapon5* >( pWeapon );
}
