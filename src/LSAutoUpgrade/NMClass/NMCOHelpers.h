...
namespace NMCOHelpers
{
	...
	,			IN	BOOL			bUseLocalNGM		= FALSE
	,			IN	LPCTSTR			szSessionID			= NULL		// 32
	,			IN	_UInt32_		uPatchType			= kPatchType_Normal
	,			IN	LPCTSTR			szPosition			= NULL		// 128
	);
	...
	,			IN	BOOL			bUseLocalNGM		= FALSE
	,			IN	LPCTSTR			szStickPath			= NULL		// 8
	,			IN	LPCTSTR			szPosition			= NULL		// 128
	);
	
	BOOL		ExecuteNGMInstaller
	(	
				IN	NMGameCode		uGameCode
	,			IN	BOOL			bWaitParent			= FALSE
	,			IN	BOOL			bLaunchAfterInstall	= FALSE
	,			IN	LPCTSTR			szArgument			= NULL		// 1024
	,			IN	LPCTSTR			szPassport			= NULL		// 1024
	,			IN	LPCTSTR			szSessionID			= NULL		// 32
	,			IN	LPCTSTR			szPosition			= NULL		// 128
