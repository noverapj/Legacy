...
//=========================================
// class CNMSetCodePageFunc
//=========================================

CNMSetCodePageFunc::CNMSetCodePageFunc( void )
: CNMFunc( kCode, 1 )
{
	this->uCodePage = CP_ACP;
}

CNMSetCodePageFunc::CNMSetCodePageFunc( UINT uCodePage )
: CNMFunc( kCode, 1 )
{
	this->uCodePage = uCodePage;
}

BEGIN_NMFUNC_SERIALIZE( CNMSetCodePageFunc )
//{
if ( this->IsCalling() )
{
	encoder.Encode4( this->uCodePage );
}
//}
END_NMFUNC_SERIALIZE()

BEGIN_NMFUNC_DESERIALIZE( CNMSetCodePageFunc )
//{
if ( this->IsCalling() )
{
	this->uCodePage	= decoder.Decode4();
}
//}
END_NMFUNC_DESERIALIZE()
...
//=========================================
// class CNMGetSecurityCodeCNFunc
//=========================================

CNMGetSecurityCodeCNFunc::CNMGetSecurityCodeCNFunc( void )
: CNMFunc( kCode, 1 )
{
	this->uSecurityCodeCN	= 0;
}

BEGIN_NMFUNC_SERIALIZE( CNMGetSecurityCodeCNFunc )
//{
if( this->IsReturn() )
{
	encoder.Encode4( this->uSecurityCodeCN );
}
//}
END_NMFUNC_SERIALIZE()

BEGIN_NMFUNC_DESERIALIZE( CNMGetSecurityCodeCNFunc )
//{
if( this->IsReturn() )
{
	this->uSecurityCodeCN	= decoder.Decode4();
}	
//}
END_NMFUNC_DESERIALIZE()

//=========================================
// class CNMGetSecurityQuestionFunc
//=========================================

CNMGetSecurityQuestionFunc::CNMGetSecurityQuestionFunc( void )
: CNMFunc( kCode, 1 )
{
}

BEGIN_NMFUNC_SERIALIZE( CNMGetSecurityQuestionFunc )
//{
if( this->IsReturn() )
{
	encoder.EncodeString( this->szSecurityQuestion );
}
//}
END_NMFUNC_SERIALIZE()

BEGIN_NMFUNC_DESERIALIZE( CNMGetSecurityQuestionFunc )
//{
if( this->IsReturn() )
{
	decoder.DecodeString( this->szSecurityQuestion.GetBuffer(), this->szSecurityQuestion.GetCapacity() );
}	
//}
END_NMFUNC_DESERIALIZE()
...
CNMExecuteNGMPatcherFunc::CNMExecuteNGMPatcherFunc( _UInt32_ uGameCode, LPCTSTR szUrl, LPCTSTR szPatchDir, LPCTSTR szExecCmdLine, BOOL bWaitParentExit, BOOL bSmallDialog, BOOL bUseLocalNGM, LPCTSTR szSessionID, _UInt32_ uPatchType, LPCTSTR szPosition )
: CNMFunc( kCode, 1 )
{
	this->uGameCode			= uGameCode;
	INIT_STRING3( szUrl );
	INIT_STRING3( szPatchDir );
	INIT_STRING3( szExecCmdLine );
	this->bWaitParentExit	= bWaitParentExit;
	this->bSmallDialog		= bSmallDialog;
	this->bUseLocalNGM		= bUseLocalNGM;
	INIT_STRING3( szSessionID );
	this->uPatchType		= uPatchType;
	INIT_STRING3( szPosition );
}
...
//{
	...
	{
		this->uGameCode			= decoder.Decode4();
		decoder.DecodeString( this->szUrl, SHRT_MAX );
		decoder.DecodeString( this->szPatchDir, MAX_PATH );
		...
		decoder.DecodeString( this->szPosition, 128 );
	}
//}
END_NMFUNC_DESERIALIZE()
...
CNMExecuteNGMLauncherFunc::CNMExecuteNGMLauncherFunc( _UInt32_ uGameCode, _UInt32_ uLaunchType, LPCTSTR szArgument, BOOL bWaitParentExit, LPCTSTR szPassport, BOOL bUseLocalNGM, LPCTSTR szStickPath, LPCTSTR szPosition )
: CNMFunc( kCode, 1 )
{
	this->uGameCode			= uGameCode;
	this->uLaunchType		= uLaunchType;
...
CNMExecuteNGMInstallerFunc::CNMExecuteNGMInstallerFunc( _UInt32_ uGameCode, BOOL bWaitParentExit, BOOL bLaunchAfterInstall, LPCTSTR szArgument, LPCTSTR szPassport, LPCTSTR szSessionID, LPCTSTR szPosition )
: CNMFunc( kCode, 1 )
{
	this->uGameCode				= uGameCode;
	this->bWaitParentExit		= bWaitParentExit;
...
CNMLoginAuthFunc::CNMLoginAuthFunc( LPCTSTR pszNexonID, LPCTSTR pszPassword, INT32 nRegionCode, LPCTSTR pszExtraData, UINT32 uChannelCode )
: CNMFunc( kCode, 1 )
{
	this->uLoginType		= kLoginType_IDPassword;
	this->szPassport[0]		= 0;
	...
	this->bSecondary		= FALSE;
	this->nRegionCode		= nRegionCode;
	StringArrayCopy( this->szExtraData, pszExtraData );
	this->nErrorCode		= kLoginAuth_ServerFailed;
	this->uChannelCode		= uChannelCode;
	this->nSubErrCode		= 0;
}
...
if ( this->IsCalling() )
{
	...
	encoder.Encode4( this->bSecondary );
	encoder.Encode4( this->nRegionCode );
	encoder.EncodeString( this->szExtraData );
	encoder.Encode4( this->uChannelCode );
}
else
{
	encoder.Encode4( this->nErrorCode );
	encoder.Encode4( this->nSubErrCode );
}
//}
END_NMFUNC_SERIALIZE()
...
if ( this->IsCalling() )
{
	...
	this->bSecondary	= decoder.Decode4();
	this->nRegionCode	= decoder.Decode4();
	decoder.DecodeString( this->szExtraData, EXTRADATA_SIZE );
	this->uChannelCode	= decoder.Decode4();
}
else
{
	this->nErrorCode	= decoder.Decode4();
	this->nSubErrCode	= decoder.Decode4();
}
//}
END_NMFUNC_DESERIALIZE()

//////////////////////////////////////////////////////////////////////////
//	class CNMLoginAuthSecurityCNFunc
//////////////////////////////////////////////////////////////////////////

CNMLoginAuthSecurityCNFunc::CNMLoginAuthSecurityCNFunc()
: CNMFunc( kCode, 1 )
, nErrorCode ( kLoginAuth_ServerFailed )
{
}

CNMLoginAuthSecurityCNFunc::CNMLoginAuthSecurityCNFunc( LPCTSTR pszPassport, LPCTSTR pszSecurityData )
: CNMFunc( kCode, 1 )
, szPassport( pszPassport )
, szSecurityData( pszSecurityData )
, nErrorCode( kLoginAuth_ServerFailed )
{
}

BEGIN_NMFUNC_SERIALIZE( CNMLoginAuthSecurityCNFunc )
//{
if ( this->IsCalling() )
{
	encoder.EncodeString( this->szPassport );
	encoder.EncodeString( this->szSecurityData );
}
else
{
	encoder.Encode4( this->nErrorCode );
...
BEGIN_NMFUNC_DESERIALIZE( CNMLoginAuthSecurityCNFunc )
//{
if ( this->IsCalling() )
{
	decoder.DecodeString( this->szPassport.GetBuffer(), this->szPassport.GetCapacity() );
	decoder.DecodeString( this->szSecurityData.GetBuffer(), this->szSecurityData.GetCapacity() );
}
else
{
	this->nErrorCode	= decoder.Decode4();
...
//////////////////////////////////////////////////////////////////////////
//	class CNMFinalizeFunc
//////////////////////////////////////////////////////////////////////////

CNMFinalizeFunc::CNMFinalizeFunc()
	: CNMFunc( kCode, 1 )
{
}

BEGIN_NMFUNC_SERIALIZE( CNMFinalizeFunc )
//{
	if ( this->IsCalling() )
	{
	}
...
BEGIN_NMFUNC_DESERIALIZE( CNMFinalizeFunc )
//{
	if ( this->IsCalling() )
	{
	}
...
//=========================================
// class CNMP2LinkerWriteChatFunc
//=========================================

CNMP2LinkerWriteChatFunc::CNMP2LinkerWriteChatFunc( void )
: CNMFunc( kCode, 1 )
, chatType( kP2ChatType_Unknown )
, uServerCode( 0 )
, nCharacterSN( 0 )
, nErrorCode( kP2ChatError_NotSupported )
{
	this->szChat[ 0 ]	= 0;
	this->szParam[ 0 ]	= 0;
}

CNMP2LinkerWriteChatFunc::CNMP2LinkerWriteChatFunc( NMP2ChatType chatType, UINT32 uServerCode, INT64 nCharacterSN, LPCTSTR szChat, LPCTSTR szParam )
: CNMFunc( kCode, 1 )
, chatType( chatType )
, uServerCode( uServerCode )
, nCharacterSN( nCharacterSN )
, nErrorCode( kP2ChatError_NotSupported )
{
	INIT_STRING2( szChat, 512 );
	INIT_STRING2( szParam, 512 );
}

BEGIN_NMFUNC_SERIALIZE( CNMP2LinkerWriteChatFunc )
//{
if ( this->IsCalling() )
{
	encoder.Encode4( this->chatType );
	encoder.Encode4( this->uServerCode );
	encoder.Encode8( this->nCharacterSN );
	encoder.EncodeString( this->szChat );
	encoder.EncodeString( this->szParam );
}
else
{
...
BEGIN_NMFUNC_DESERIALIZE( CNMP2LinkerWriteChatFunc )
//{
if ( this->IsCalling() )
{
	this->chatType		= ( NMP2ChatType )decoder.Decode4();
	this->uServerCode	= decoder.Decode4();
	this->nCharacterSN	= decoder.Decode8();
	decoder.DecodeString( this->szChat, 512 );
	decoder.DecodeString( this->szParam, 512 );
}
else
{
	this->nErrorCode	= ( NMP2ChatError )decoder.Decode4();
}
//}
END_NMFUNC_DESERIALIZE()
...
CNMFunc* CNMUtil::CreateFuncFromCode( _UInt32_ uCode )
{
	switch ( uCode )
	{
		...
		NMFUNC_MAP( CNMRegisterCallbackFunc )
			...
			NMFUNC_MAP( CNMGetSecurityCodeCNFunc )
			NMFUNC_MAP( CNMGetSecurityQuestionFunc )
			NMFUNC_MAP( CNMGetNxHWIDFunc )
			NMFUNC_MAP( CNMSetCodePageFunc )
			...
			// p2 linker
			NMFUNC_MAP( CNMP2LinkerWriteChatFunc )
