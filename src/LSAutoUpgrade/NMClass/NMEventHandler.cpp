...
void CNMEventHandler::OnNMEvent( CNMEvent* pEvent )
{
	BEGIN_NMEVENT_MAP
		...
		ON_NMEVENT( CNMLogReportSyncEvent, OnLogReportSyncEvent )
		...
		ON_NMEVENT( CNMP2PLoginReplyEvent, OnP2PLoginReplyEvent )
		ON_NMEVENT( CNMP2PSendDataReplyEvent, OnP2PSendDataReplyEvent )
		ON_NMEVENT( CNMP2PMessageEvent, OnP2PMessageEvent )
		ON_NMEVENT( CNMP2PConnectionClosedEvent, OnP2PConnectionClosedEvent )
...
void CNMEventHandler::OnLogReportSyncEvent( CNMLogReportSyncEvent* pEvent ) { UNREFERENCED_PARAMETER(pEvent); }
...
void CNMEventHandler::OnP2PLoginReplyEvent( CNMP2PLoginReplyEvent* pEvent ) { UNREFERENCED_PARAMETER(pEvent); }
void CNMEventHandler::OnP2PSendDataReplyEvent( CNMP2PSendDataReplyEvent* pEvent ) { UNREFERENCED_PARAMETER(pEvent); }
void CNMEventHandler::OnP2PMessageEvent( CNMP2PMessageEvent* pEvent ) { UNREFERENCED_PARAMETER(pEvent); }
void CNMEventHandler::OnP2PConnectionClosedEvent( CNMP2PConnectionClosedEvent* pEvent ) { UNREFERENCED_PARAMETER(pEvent); }
...
void CNMMainEventHandler::OnLogReportSyncEvent( CNMLogReportSyncEvent* pEvent ) { UNREFERENCED_PARAMETER(pEvent); }
