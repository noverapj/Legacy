...
protected:
	...
	virtual void	OnLogReportSyncEvent( CNMLogReportSyncEvent * pEvent );
	...
	virtual void	OnP2PLoginReplyEvent( CNMP2PLoginReplyEvent* pEvent );
	virtual void	OnP2PSendDataReplyEvent( CNMP2PSendDataReplyEvent* pEvent );
	virtual void	OnP2PMessageEvent( CNMP2PMessageEvent* pEvent );
	virtual void	OnP2PConnectionClosedEvent( CNMP2PConnectionClosedEvent* pEvent );
};
