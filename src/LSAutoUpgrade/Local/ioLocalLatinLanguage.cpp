...
namespace LatinLanguage
{
	const char *GetMemTextList()
	{
		return "|EXE_CAutoUpgradeApp::IsDuplication_1|\r\n\r\n      [LostSaga] est?abierto.\r\n\r\n      Int?talo nuevamente cuando cierres [Lost Saga].\r\n\r\n\r\n      (C?igo de error:201)|"
			...
			"|EXE_CAutoUpgradeDlg::OnTimer_3|Error al conectar al servidor de Lost Saga..|"
			...
			"|EXE_CAutoUpgradeDlg::OnTimer_8|Ha ocurrido un error al ejecutar el cliente.\r\n(C?igo de error:226)|"
			"|EXE_CAutoUpgradeDlg::OnTimer_9|Ha ocurrido un error al ejecutar el cliente.|"
			"|EXE_CAutoUpgradeDlg::SetWantEndDialog_1|Exiting... Please wait.|"
			"|EXE_Help::CheckRightHDDSpace_1|Se requiere que haya %1 megas libres en tu disco duro para que \r\nla actualizaci? de Lost Saga pueda proceder.\r\n(error code:207)\r\n\r\nTama? total:%2M, tama? restante:%3M, tama? necesario:%4M|"
			...
			"|EXE_HTTPManager::_Run_1|Reuniendo informaci? de Parche...|"
			"|EXE_HTTPManager::_Run_2|La versi? instalada del DirectX est?desactualizada.\r\nInstala la ?tima versi? del DirectX, tarjeta gr?ica y controlador.\r\n(C?igo de error:211)|"
			"|EXE_HTTPManager::_Run_3|Se ha fallado al abir el iop n?ero %1. Y ocurri?un error al eliminar el archivo.\r\nNombre del archivo:%2, GetLastError:%3 Vuelve a ejecutar el programa.\r\n(C?igo de error:222)\r\n\r\n|"
			"|EXE_HTTPManager::_Run_4|La descarga de los archivos ha fallado.\r\nPuede que los archivos del parchese hayan amontonado.\r\nVuelve a intentarlo m? tarde.\r\n(C?igo de error:203)\r\n\r\n|"
			"|EXE_HTTPManager::_Run_5|Los archivos est? da?dos.\r\nPuede que los archivos del parche se hayan amontonado.\r\nVuelve a ejecutar el programa m? tarde.\r\n(C?igo de error:215)\r\n\r\n|"
			"|EXE_HTTPManager::_Run_6|No se ha podido abrir el paquete de archivos.\r\nVerifica si hay alg? problema con la sincronizaci? de\r\nlos archivos del parche y vuelve a intentarlo.\r\n(C?igo de error:204)\r\n\r\n|"
			"|EXE_HTTPManager::_Run_7|Hubo un error con el an?isis de los archivos.\r\n Vuelve a ejecutar el programa.\r\n(C?igo de error:205)\r\n\r\n|"
			"|EXE_HTTPManager::_Run_8|Ha ocurrido un error al verificar cu?to espacio hay en el disco duro.\r\nAl parecer hay suficiente espacio\r\nen el disco duro para continuar con el procedimiento.\r\nSi el problema continua, recupera el espacio del disco.\r\n(C?igo de error: 223)\r\n\r\nGetLastError:%1|"
			"|EXE_HTTPManager::_Run_9|La descarga y reanudaci? del archivo ha fallado (Ha fallado 100 veces).\r\nVuelve a ejecutar el programa.\r\nSi el problema persiste, ingresa al men?de\r\nprogramas y elimina Lost Saga. Luego verifica que est? libre de virus.\r\nNo te olvides de verificar la conexi? de internet.\r\n(C?igo de error: 206)\r\n\r\n|"
			...
			"|EXE_HTTPManager::CreateAllNewPacFile_1|La optimizaci? %1 de los archivos ha fallado.\r\n Vuelve a ejecutar el programa.\r\n(C?igo de error: 212)\r\n\r\n%2|"
			...
			"|EXE_HTTPManager::CreateNewPacFile_14|Optimizando:%1/%2 files [%3%%].|"
			...
			"|EXE_HTTPManager::InitPac_1|La asignaci? del paquete de biblioteca de memorias ha fallado.\r\n Vuelve a ejecutar el programa.\r\n(C?igo de error: 213)\r\n\r\nArray: %1, GetLastError: %2|"
			"|EXE_HTTPManager::OpenAllBigPacForGarbageSize_1|Se ha fallado al abir el iop n?ero %1.\r\nNombre del archivo:%2, GetLastError:%3 Vuelve a ejecutar el programa.\r\n(C?igo de error: 225)\r\n\r\n|"
			"|EXE_HTTPManager::ParseDeleteFileList_1|Analizando archivos para eliminarlos.|"
			...
			"|EXE_HTTPManager::ProcessNewPacFile_1|Ya fue optimizado.|"
			"|EXE_HTTPManager::ProcessNewPacFile_2|Ya fue optimizado.|"
			"|EXE_HTTPManager::Run_1|Ha ocurrido un error en la Sincronizaci? Principal.\r\n Vuelve a ejecutar el programa.\r\n(C?igo de error: 209)\r\n\r\n|"
			"|EXE_HTTPManager::SetTextWaitNewPac_1|Verificando optimizaci?.[%1]|"
			...
			"|EXE_HTTPManager::StartGame_1|Se est? ejecutando el juego.|"
			...
			"|EXE_HTTPManager::StartGame_4|Presionar [Espacio] para iniciar el juego.|"
			...
			"|EXE_HTTPManager::UpdateOneFile_1|Ha ocurrido un error en la descarga del archivo.\r\nComenzaremos con la reconstrucci? autom?ica.(total 100 veces)\r\nSi quieres cerrar el programa\r\npresiona X en el bot? actualizaci? autom?ica.\r\n(C?igo de error: 218)\r\n\r\n|"
			...
			"|EXE_HTTPManager::UpdateOneFile_6|Se ha cambiado el tama? del archivo descargado.\r\nNo se ha renovado los archivos del parche\r\no ha sido infectado por virus.\r\nSi el problema persiste, procede con las siguientes pautas.\r\n\r\n1. Eliminar la carpeta que [LostSaga] ha instalado.\r\n   Herramientas de Internet Explorer 7->Opciones de internet->Pesta?: General->Eliminar...->Eliminar todo->[Eliminar tambi? los archivos guardados y los ajustes]->Ejemplo,\r\n   Herramientas de Internet Explorer 7->Opciones de internet->Pesta?: General->Eliminar Cookies->Aceptar\r\n                                   Herramientas->Opciones de internet->Pesta?: General->Eliminar archivos->[Eliminar todos los art?ulos offline]->Aceptar|"
			"|EXE_HTTPManager::UpdateOneFile_7|Sever file size: %1, Downloaded file size: %2, Server file CRC: %3|"
			"|EXE_HTTPManager::UpdateOneFile_8|Ha ocurrido un error al juntar todos los archivos.\r\nComenzaremos con la reconstrucci? autom?ica.(total 100 veces)\r\nSi quieres cerrar el programa\r\npresiona X en el bot? actualizaci? autom?ica.\r\n(C?igo de error: 219)\r\n\r\n|"
			"|EXE_HTTPManager::UpdateOneFile_9|Server file size: %1, Downloaded file size: %2, Server file CRC: %3|"
			"|EXE_HTTPManager::UpdateOneFile_10|Ha ocurrido un error al abrir los archivos individualmente.\r\nComenzaremos con la reconstrucci? autom?ica.(total 100 veces)\r\nSi quieres cerrar el programa\r\npresiona X en el bot? actualizaci? autom?ica.\r\n(C?igo de error: 220)\r\n\r\n|"
			"|EXE_HTTPManager::UpdateOneFile_11|Server file size: %1, Downloaded file size: %2, Server file CRC: %3|"
			"|EXE_HTTPManager::UpdateOneFile_12|Ha ocurrido un error al copiarse los archivos.\r\nComenzaremos con la reconstrucci? autom?ica.(total 100 veces)\r\nSi quieres cerrar el programa\r\npresiona X en el bot? actualizaci? autom?ica.\r\n(C?igo de error: 221)\r\n\r\n|"
			"|EXE_HTTPManager::UpdateOneFile_13|Server file size: %1, Downloaded file size: %2|"
			"|EXE_HTTPManager::UpdateOneFile_14|La instalaci? de la versi? completa ha fallado.\r\nComenzaremos con la reconstrucci? autom?ica.(total 100 veces)\r\npresiona X en el bot? actualizaci? autom?ica\r\nSi quieres cerrar el programa.\r\n(C?igo de error: 217)\r\n\r\n|"
