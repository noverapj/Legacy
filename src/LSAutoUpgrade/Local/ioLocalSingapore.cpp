...
DWORD ioLocalSingapore::GetResourceIDBackBmp()
{
	return IDB_BACK_US;
}

DWORD ioLocalSingapore::GetResourceIDOptimizeBtnBmp()
{
	return IDB_OPTIMIZE_BTN_US;
}

DWORD ioLocalSingapore::GetResourceIDStartBtnBmp()
{
	return IDB_START_US;
}

DWORD ioLocalSingapore::GetResourceIDErrorBackBtnBmp()
{
	return IDB_ERROR_BACK_US;
}

DWORD ioLocalSingapore::GetResourceIDErrorSolutionBtnBmp()
{
	return IDB_SOLUTIONBTN_US;
}

DWORD ioLocalSingapore::GetResourceIDErrorExitBtnBmp()
{
	return IDB_EXITBTN_US;
}

DWORD ioLocalSingapore::GetResourceIDLoginEntryBtnBmp()
{
	return IDB_SOLUTIONBTN_SEA;
}

DWORD ioLocalSingapore::GetResourceIDLoginFindIDBtnBmp()
{
	return IDB_LOGIN_FINDID_BTN_SEA;
}

DWORD ioLocalSingapore::GetResourceIDLoginFindPWBtnBmp()
{
	return IDB_LOGIN_FINDPW_BTN_SEA;
}

const char * ioLocalSingapore::GetRegKey()
{
	return "Software\\SP2ClientSEA\\";
}
...
void ioLocalSingapore::CreateShortcuts( const CString &rszRootDir, const CString &rszShortcutName, const CString &rszLoginURL )
{
...
{
	return "http://www.playone.asia/support/faq";
}
...
int ioLocalSingapore::GetLoginKeyLiveTime()
{
	return ( LOGIN_KEY_LIVE_TIME*100 ); // 서버에서 로그인을 하므로 로그인키 생존 시간이 필요 없기때문에 아주길게 설정
}

void ioLocalSingapore::SetLoginData( const char *szLoginID, const char *szLoginEncodePW )
{
	if( szLoginID == NULL )
		return;
...
void ioLocalSingapore::SetServerID( const char *szServerID )
{
	if( szServerID == NULL )
		return;
...
bool ioLocalSingapore::IsRightPW( const char *szPW )
{
	enum { MIN_LENGTH = 6,  };
...
const char * ioLocalSingapore::GetConnectFailMent()
{
...
const char * ioLocalSingapore::GetLoginWrongIDMent()
{
	return "Wrong ID";
}

const char * ioLocalSingapore::GetLoginWrongPWMent()
{
	return "Wrong Password";
}

const char * ioLocalSingapore::GetServerFullMent()
{
	return "Game Server is full.\r\n(Error Code:228)";
}

const char * ioLocalSingapore::GetEntryURL()
{
	return "http://www.playone.asia/member/register";
}

const char * ioLocalSingapore::GetFindIDURL()
{
	return "http://www.playone.asia/member/profile";
}

const char * ioLocalSingapore::GetFindPWURL()
{
	return "http://www.playone.asia/member/find_password";
}
