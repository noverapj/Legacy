...
CString HttpApp::GetFileModified()
{
	CString str="";
	if(m_pInternetFile == NULL) return str;
	...
	DWORD dwSize = 50;
	if( pHttpFile)
		pHttpFile->QueryInfo(HTTP_QUERY_LAST_MODIFIED, strContentLength, &dwSize);	

	str = strContentLength;			
