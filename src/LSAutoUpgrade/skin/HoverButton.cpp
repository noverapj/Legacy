...
//				mydc->BitBlt(0,0,m_ButtonSize.cx,m_ButtonSize.cy,pMemDC,m_ButtonSize.cx,0,SRCCOPY);
				mydc->TransparentBlt(0, 0, m_ButtonSize.cx, m_ButtonSize.cy, pMemDC, 
								m_ButtonSize.cx, 0, m_ButtonSize.cx, m_ButtonSize.cy, RGB(0, 255, 0));
			else
			{
				if( m_bDisableImg )
//					mydc->BitBlt(0,0,m_ButtonSize.cx,m_ButtonSize.cy,pMemDC,m_ButtonSize.cx*3,0,SRCCOPY);
					mydc->TransparentBlt(0, 0, m_ButtonSize.cx, m_ButtonSize.cy, pMemDC, 
								m_ButtonSize.cx*3, 0, m_ButtonSize.cx, m_ButtonSize.cy, RGB(0, 255, 0));
				else
//					mydc->BitBlt(0,0,m_ButtonSize.cx,m_ButtonSize.cy,pMemDC,m_ButtonSize.cx,0,SRCCOPY);
					mydc->TransparentBlt(0, 0, m_ButtonSize.cx, m_ButtonSize.cy, pMemDC, 
								m_ButtonSize.cx, 0, m_ButtonSize.cx, m_ButtonSize.cy, RGB(0, 255, 0));
...
//					mydc->BitBlt(0,0,m_ButtonSize.cx,m_ButtonSize.cy,pMemDC,m_ButtonSize.cx*2,0,SRCCOPY);
					mydc->TransparentBlt(0, 0, m_ButtonSize.cx, m_ButtonSize.cy, pMemDC, 
								m_ButtonSize.cx * 2, 0, m_ButtonSize.cx, m_ButtonSize.cy, RGB(0, 255, 0));
				else
//					mydc->BitBlt(0,0,m_ButtonSize.cx,m_ButtonSize.cy,pMemDC,0,0,SRCCOPY);
					mydc->TransparentBlt(0, 0, m_ButtonSize.cx, m_ButtonSize.cy, pMemDC, 
										0, 0, m_ButtonSize.cx, m_ButtonSize.cy, RGB(0, 255, 0));
			}
			else
			{
				if( m_bDisableImg )
...
//	mybitmap.Attach(::LoadImage(::AfxGetInstanceHandle(),MAKEINTRESOURCE(bitmapid), IMAGE_BITMAP,0,0, LR_CREATEDIBSECTION ));
