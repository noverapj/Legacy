// LSLogClient.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CLSLogClientApp, CWinApp)
...
CLSLogClientApp::CLSLogClientApp()
{
...
// 유일한 CLSLogClientApp 개체입니다.

CLSLogClientApp theApp;


// CLSLogClientApp 초기화

BOOL CLSLogClientApp::InitInstance()
{
