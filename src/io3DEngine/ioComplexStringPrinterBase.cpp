...
char ioComplexStringPrinterBase::m_szBuffer[ioComplexStringPrinterBase::BUFFER_SIZE];

ioComplexStringPrinterBase::ioComplexStringPrinterBase()
{
...
void ioComplexStringPrinterBase::SetTextColor( int iRed, int iGreen, int iBlue )
{
	m_dwTextColor = D3DCOLOR_XRGB( iRed, iGreen, iBlue );
}

void ioComplexStringPrinterBase::SetTextColor( DWORD dwTextColor )
{
	m_dwTextColor = dwTextColor;
}

void ioComplexStringPrinterBase::SetFullTextColor( DWORD dwTextColor )
{
...
void ioComplexStringPrinterBase::SetFullTextStyle( TextStyle eStyle )
{
	int iPieceCnt = m_vPieceList.size();
	for( int i=0 ; i<iPieceCnt ; i++ )
	{
...
void ioComplexStringPrinterBase::SetBkColor( int iRed, int iGreen, int iBlue )
{
	m_dwBkColor = D3DCOLOR_XRGB( iRed, iGreen, iBlue );
}

void ioComplexStringPrinterBase::SetBkColor( DWORD dwBkColor )
{
	m_dwBkColor = dwBkColor;
}

void ioComplexStringPrinterBase::SetFullBkColor( DWORD dwBkColor )
{
	int iPieceCnt = m_vPieceList.size();
	for( int i=0 ; i<iPieceCnt ; i++ )
	{
...
void ioComplexStringPrinterBase::SetTextStyle( TextStyle eStyle )
{
	m_TextStyle = eStyle;
}

void ioComplexStringPrinterBase::UpdateFullWidth()
{
	m_fFullWidth = 0.0f;
...
void ioComplexStringPrinterBase::SetTextPiece( float fScale, float fYOffset )
{
...
void ioComplexStringPrinterBase::SetTextPieceWithoutXOffset( float fScale, float fYOffset )
{
	if( strcmp( m_szBuffer, "" ) == 0 )
		return;
...
void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, ... )
{
...
void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, int iArg1 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, iArg1 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, DWORD dwArg1 )
{
...
void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, float fArg1 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, fArg1 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, __int64 i64Arg1 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, i64Arg1 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, const char *szArg1 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, szArg1 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, int iArg1, int iArg2 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, iArg1, iArg2 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, int iArg1, const char *szArg2 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, iArg1, szArg2 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, const char *szArg1, int iArg2 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, szArg1, iArg2 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, const char *szArg1, const char *szArg2 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, szArg1, szArg2 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, int iArg1, int iArg2, int iArg3 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, iArg1, iArg2, iArg3 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, int iArg1, const char *szArg2, const char *szArg3 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, iArg1, szArg2, szArg3 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, const char *szArg1, int iArg2, int iArg3 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, szArg1, iArg2, iArg3 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, const char *szArg1, int iArg2, const char *szArg3 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, szArg1, iArg2, szArg3 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, const char *szArg1, const char *szArg2, const char *szArg3 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, szArg1, szArg2, szArg3 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, int iArg1, int iArg2, int iArg3, int iArg4 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, iArg1, iArg2, iArg3, iArg4 );
	SetTextPiece( fScale, 0.0f );
}

void ioComplexStringPrinterBase::AddTextPiece( float fScale, const char *szSource, int iArg1, int iArg2, int iArg3, int iArg4, int iArg5 )
{
...
#ifdef USE_LIST_ARQUMENTS_TEXT_FUNCTION
void ioComplexStringPrinterBase::AddTextPieceWithYOffset( float fScale, float fYOffset, const char *szSource, ... )
{
	if( ioLocalManagerParent::IsVPrintf() )
	{
		va_list args;
...
void ioComplexStringPrinterBase::AddTextPieceWithYOffset( float fScale, float fYOffset, const char *szSource, int iArg1 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, iArg1 );
	SetTextPiece( fScale, fYOffset );
}

void ioComplexStringPrinterBase::AddTextPieceWithYOffset( float fScale, float fYOffset, const char *szSource, const char *szArg1 )
{
	SafeSprintf( m_szBuffer, BUFFER_SIZE, szSource, szArg1 );
	SetTextPiece( fScale, fYOffset );
}
...
#ifdef USE_LIST_ARQUMENTS_TEXT_FUNCTION
void ioComplexStringPrinterBase::AddTextPieceWithoutXOffset( float fScale, const char *szSource, ... )
{
	if ( ioLocalManagerParent::IsVPrintf() )
	{
		va_list args;
...
void ioComplexStringPrinterBase::CopyFullText( ioComplexStringPrinterBase &rkPrinter ) const
{
	rkPrinter.ClearList();
...
void ioComplexStringPrinterBase::CopyOnlyText( OUT std::string &rkText ) const
{
	rkText.clear();
...
void ioComplexStringPrinterBase::CopyModifyScaleText( ioComplexStringPrinterBase &rkPrinter, float fScale )
{
	rkPrinter.ClearList();
	rkPrinter.m_dwTextColor = m_dwTextColor;
	rkPrinter.m_dwBkColor   = m_dwBkColor;
...
void ioComplexStringPrinterBase::SplitFullText( ioComplexStringPrinterBase &rkPrinterA, ioComplexStringPrinterBase &rkPrinterB, float fSplitWidth )
{
	...
	if( !m_vPieceList.empty() )
	{
		...
		for(;i < iSize;i++)
		{
			...
			else
			{
				...
				int iLen = StringCutFunc( kPiece.fScale, fRemainWidth, kPiece.eStyle, szDst, sizeof( szDst ), szSrc );
				kPiece.szText = szDst;
...
bool ioComplexStringPrinterBase::IsCompare( const ioComplexStringPrinterBase &rkPrinter ) const
{
...
void ioComplexStringPrinterBase::PrintFullText( float fXPos,
										    float fYPos,
...
void ioComplexStringPrinterBase::PrintFullModifyText( float fXPos,
												  float fYPos,
												  DWORD dwTextColor,
												  TextStyle eStyle,
												  TextAlignType eAlign,
...
void ioComplexStringPrinterBase::PrintFullTextWidthCut( float fXPos,
										            float fYPos,
										            TextAlignType eAlign,
													float fWidth,
										            BYTE bAlpha /*=255*/)
...
float ioComplexStringPrinterBase::PrintFullTextWidthDirectCut( float fXPos,
														  float fYPos,
														  TextAlignType eAlign,
														  float fWidth,
														  BYTE bAlpha /*=255*/ )
{
	...
	for( int i=0 ; i<iPieceCnt ; i++ )
	{
		...
		char szDst[MAX_PATH] = "";
		memset( szDst, 0, sizeof( szDst ) );
		StringCutFunc( rkPiece.fScale, fWidth, rkPiece.eStyle, szDst, sizeof(szDst), rkPiece.szText.c_str() );
		if( bAlpha == 255 )
		{
...
void ioComplexStringPrinterBase::ClearList()
{
	if( !m_vPieceList.empty()  )
	{
		m_vPieceList.clear();
