...
#ifndef _ioBipedTrailAffector_h_
#define _ioBipedTrailAffector_h_
...
class __EX ioBipedTrailAffector : public ioParticleAffector
{
public:
...
public:
	ioBipedTrailAffector();
	virtual ~ioBipedTrailAffector();
};
