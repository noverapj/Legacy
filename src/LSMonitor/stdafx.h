...
#pragma comment(lib, "../../src/LSMonitor/IOSocketDLL/IOSocketDDLL.lib")
#else
#pragma comment(lib, "../../src/LSMonitor/IOSocketDLL/IOSocketDLL.lib")
#pragma comment(lib, "../../lib/LSLog.lib" )
#pragma comment(lib, "../../lib/TownPortal.lib")
//#pragma comment(lib, "IOSocketDLL/IOSocketDLL.lib")
