#ifndef _ioTargetDebuffSkill2_h_
#define _ioTargetDebuffSkill2_h_
...
class ioTargetDebuffSkill2 : public ioNormalSkill
{
public:
	enum SkillState
	{
...
public:
	ioTargetDebuffSkill2();
	ioTargetDebuffSkill2( const ioTargetDebuffSkill2 &rhs );
	virtual ~ioTargetDebuffSkill2();
};

inline ioTargetDebuffSkill2* ToTargetDebuffSkill2( ioSkill *pSkill )
{
	ioNormalSkill *pNormal = ToNormalSkill( pSkill );
	if( !pNormal || pNormal->GetSubSkillType() != NST_TARGET_DEBUFF2 )
		return NULL;

	return dynamic_cast< ioTargetDebuffSkill2* >( pSkill );
}
