...
class ioCreateEquipItemSkill : public ioNormalSkill
{
public:
	enum CreateState
	{
...
public:
	ioCreateEquipItemSkill();
	ioCreateEquipItemSkill( const ioCreateEquipItemSkill &rhs );
	virtual ~ioCreateEquipItemSkill();
};

inline ioCreateEquipItemSkill* ToCreateEquipItemSkill( ioSkill *pSkill )
{
	ioNormalSkill *pNormal = ToNormalSkill( pSkill );
	if( !pNormal || pNormal->GetSubSkillType() != NST_CREATE_EQUIP_ITEM )
		return NULL;

	return dynamic_cast< ioCreateEquipItemSkill* >( pSkill );
}
