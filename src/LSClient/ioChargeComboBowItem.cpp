...
void ioChargeComboBowItem::ChangeToNextComboState( ioBaseChar *pOwner )
{
	...
	if( !COMPARE( m_iChargeCombo, 0, (int)m_vChargeComboAttListCenter.size() ) )
		return;
...
void ioChargeComboBowItem::WasteBullet()
{
...
AttackAttribute* ioChargeComboBowItem::GetCorrectDirAttibute( ioBaseChar *pOwner )
{
	...
	if( !m_AimedTarget.IsEmpty() && COMPARE( m_iChargeCombo, 0, (int)m_vChargeComboAttListCenter.size() ) )
	{
