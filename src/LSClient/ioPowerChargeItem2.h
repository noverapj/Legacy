...
class ioPowerChargeItem2 : public ioWeaponItem
{
protected:
...
public:
	ioPowerChargeItem2();
	ioPowerChargeItem2( const ioPowerChargeItem2 &rhs );
	virtual ~ioPowerChargeItem2();
};

inline ioPowerChargeItem2* ToPowerChargeItem2( ioItem *pItem )
{
	ioWeaponItem *pWeapon = ToWeaponItem( pItem );
	if( !pWeapon || pWeapon->GetSubType() != ioWeaponItem::WST_POWER_CHARGE2 )
		return NULL;

	return dynamic_cast< ioPowerChargeItem2* >( pItem );
}
