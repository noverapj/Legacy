...
class ioComboMoveAttack5Skill : public ioNormalSkill
{
public:
	enum SkillState
	{
...
public:
	ioComboMoveAttack5Skill();
	ioComboMoveAttack5Skill( const ioComboMoveAttack5Skill &rhs );
	virtual ~ioComboMoveAttack5Skill();
};

inline ioComboMoveAttack5Skill* ToComboMoveAttack5Skill( ioSkill *pSkill )
{
	ioNormalSkill *pNormal = ToNormalSkill( pSkill );
	if( !pNormal || pNormal->GetSubSkillType() != NST_COMBO_MOVE_ATTACK5 )
		return NULL;

	return dynamic_cast< ioComboMoveAttack5Skill* >( pSkill );
}
