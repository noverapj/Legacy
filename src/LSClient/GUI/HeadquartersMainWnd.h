...
typedef struct tagHeadquartersInfo
{
...
typedef struct tagHeadquartersUserInfo
{
...
}HeadquartersUserInfo;

class HeadquartersInfoWnd : public ioMovingWnd
{
public:
	enum 
	{
...
protected:
	...
	HeadquartersInfo m_HeadquartersInfo;
	typedef std::vector< HeadquartersUserInfo > vUserInfo;
...
public:
	HeadquartersInfoWnd();
	virtual ~HeadquartersInfoWnd();
};
//////////////////////////////////////////////////////////////////////////
class HeadquartersJoinRequestWnd : public ioMovingWnd
{
public:
	enum
	{
...
public:
	HeadquartersJoinRequestWnd();
	virtual ~HeadquartersJoinRequestWnd();
};
//////////////////////////////////////////////////////////////////////////
class HeadquartersMainOptionWnd : public ioWnd
{
public:
	enum
	{
...
public:
	HeadquartersMainOptionWnd();
	virtual ~HeadquartersMainOptionWnd();
};

class HeadquartersMainWnd : public ioMovingWnd
{
public:
	enum 
	{
...
public:
	HeadquartersMainWnd();
	virtual ~HeadquartersMainWnd();
};
//////////////////////////////////////////////////////////////////////////
class HeadquartersOwnerWnd : public ioWnd
{
...
public:
	HeadquartersOwnerWnd();
	virtual ~HeadquartersOwnerWnd();
};
//////////////////////////////////////////////////////////////////////////
class HeadquartersInviteList : public ioButton
{
public:
	enum
	{
...
public:
	HeadquartersInviteList();
	virtual ~HeadquartersInviteList();
};

class HeadquartersInviteListWnd : public ioMovingWnd
{
public:
	enum
	{
...
public:
	HeadquartersInviteListWnd();
	virtual ~HeadquartersInviteListWnd();
};
//////////////////////////////////////////////////////////////////////////
class HeadquartersInvitedBtn : public ioButton
{
protected:
	ioUIRenderImage *m_pPeopleOrange;
	ioUIRenderImage *m_pPeopleGray;
...
public:
	HeadquartersInvitedBtn();
	virtual ~HeadquartersInvitedBtn();
};
//////////////////////////////////////////////////////////////////////////
class HeadquartersInvitedWnd : public ioMovingWnd
{
public:
	enum 
	{
...
protected:
	void JoinHeadquarters();
	const HeadquartersUserInfo &GetUserInfo( int iArray );
...
public:
	HeadquartersInvitedWnd();
	virtual ~HeadquartersInvitedWnd();
};
