#ifndef _ioTargetDebuffSkill6_h_
#define _ioTargetDebuffSkill6_h_
...
class ioTargetDebuffSkill6 : public ioNormalSkill
{
public:
	enum SkillState
	{
...
protected:
	...
	AttackAttribute m_AimAirAttribute;
	AttackAttribute m_AimLandAttribute;
...
public:
	ioTargetDebuffSkill6();
	ioTargetDebuffSkill6( const ioTargetDebuffSkill6 &rhs );
	virtual ~ioTargetDebuffSkill6();
};

inline ioTargetDebuffSkill6* ToTargetDebuffSkill6( ioSkill *pSkill )
{
	ioNormalSkill *pNormal = ToNormalSkill( pSkill );
	if( !pNormal || pNormal->GetSubSkillType() != NST_TARGET_DEBUFF6 )
		return NULL;

	return dynamic_cast< ioTargetDebuffSkill6* >( pSkill );
}
