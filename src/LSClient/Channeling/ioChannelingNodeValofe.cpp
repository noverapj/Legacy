...
const char * ioChannelingNodeValofe::GetININame()
{
	return "config/sp2_channeling_valofe.ini";
}

const char * ioChannelingNodeValofe::GetLogoSetName()
{
	return "LogoDefault";
}

bool ioChannelingNodeValofe::OnRecieveGetCash( SP2Packet &rkReceivePacket )
{
	int iCash          = 0;
...
void ioChannelingNodeValofe::GetFillCashURL( OUT ioHashString &rsFullURL , IN const ioHashString &rsShortURL )
{
...
void ioChannelingNodeValofe::GetLoginURL( OUT ioHashString &rsFullURL, IN const ioHashString &rsShortURL, IN const ioHashString &rsLoginKey )
{
...
int ioChannelingNodeValofe::GetCashPageWidth()
{
	return 550; 
}

int ioChannelingNodeValofe::GetCashPageHeight()
{
	return 580;
}

void ioChannelingNodeValofe::OnCashPageHide()
{
...
bool ioChannelingNodeValofe::IsCreateProcessFillCashWeb()
{
	return false;
}

const char * ioChannelingNodeValofe::GetBillingErrorMent(ioHashString &sServerError)
{
...
bool ioChannelingNodeValofe::OnRecieveAddCash( SP2Packet &rkReceivePacket )
{
	int iCash          = 0;
	int iPurchasedCash = 0;
	rkReceivePacket >> iCash;
