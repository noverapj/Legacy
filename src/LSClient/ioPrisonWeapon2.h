...
class ioPrisonWeapon2 : public ioWeapon
{
public:
...
public:
	ioPrisonWeapon2( ioBaseChar *pOwner, const WeaponAttribute *pAttr );
	virtual ~ioPrisonWeapon2();
};

inline ioPrisonWeapon2* ToPrisonWeapon2( ioWeapon *pWeapon )
{
	if( !pWeapon || pWeapon->GetType() != ioWeapon::WT_PRISON_WEAPON2 )
		return NULL;

	return dynamic_cast< ioPrisonWeapon2* >( pWeapon );
}