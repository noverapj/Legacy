...
bool ioLocalBrazil::IsRightGameServerID( const CString &rszGameServerID )
{
...
DWORD ioLocalBrazil::GetResourceIDBack()
{
	return IDB_BACK;
}

DWORD ioLocalBrazil::GetResourceIDChange()
{
	return IDB_CHANGEBTN;
}

DWORD ioLocalBrazil::GetResourceIDSetup()
{
	return IDB_SETUPBTN;
}

DWORD ioLocalBrazil::GetResourceIDErrorBack()
{
	return IDB_ERROR_BACK;
}

DWORD ioLocalBrazil::GetResourceIDErrorExit()
{
	return IDB_EXITBTN;
}

DWORD ioLocalBrazil::GetResourceIDErrorSolution()
{
	return -1;
}
...
void ioLocalBrazil::SetRegKey( const char *szReg )
{
	StringCbCopy( m_szRegKey, sizeof( m_szRegKey ), szReg );
}

void ioLocalBrazil::SetStartURL( const char *szURL )
{
	StringCbCopy( m_szStartURL, sizeof( m_szStartURL ), szURL );
}

bool ioLocalBrazil::IsLoginDlg()
{
	return false;
}
...
bool ioLocalBrazil::UpdateNRunSteamLauncher( CSetupAndStart* SetUpAndStart )
{
