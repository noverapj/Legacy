...
bool ioLocalPhilippine::IsRightGameServerID( const CString &rszGameServerID )
{
	return true;
}
...
DWORD ioLocalPhilippine::GetResourceIDBack()
{
	return IDB_BACK_ID;
}

DWORD ioLocalPhilippine::GetResourceIDChange()
{
	return IDB_CHANGEBTN_ID;
}

DWORD ioLocalPhilippine::GetResourceIDSetup()
{
...
DWORD ioLocalPhilippine::GetResourceIDErrorExit()
{
	return IDB_EXITBTN;
}

DWORD ioLocalPhilippine::GetResourceIDErrorSolution()
{
	return -1;
}
...
{
	return "http://www.lostsaga.ph/";
}

void ioLocalPhilippine::SetRegKey( const char *szReg )
{
	StringCbCopy( m_szRegKey, sizeof( m_szRegKey ), szReg );
}

void ioLocalPhilippine::SetStartURL( const char *szURL )
{
	StringCbCopy( m_szStartURL, sizeof( m_szStartURL ), szURL );
}

bool ioLocalPhilippine::IsLoginDlg()
{
	return false;
}
...
bool ioLocalPhilippine::IsReadRegClientPath()
{
	return false;
}
