...
void ioLocalManager::SetLocalType( const char *szLocal )
{
	...
	else if( strcmp( szLocal , "SINGAPORE" ) == 0 )
		m_eLocalType = LCT_SINGAPORE;
	else if( strcmp( szLocal , "BRAZIL" ) == 0 )
		m_eLocalType = LCT_BRAZIL;
	else if( strcmp( szLocal , "PHILIPPINE" ) == 0 )
		m_eLocalType = LCT_PHILIPPINE;
}
